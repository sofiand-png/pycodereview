...
- [CRSS-Python Repository & Publication Standard](#crss-python-repository-publication-standard)
  - [0. Purpose](#0-purpose)
  - [1. Document Taxonomy](#1-document-taxonomy)
    - [1.1 Normative vs Informative](#11-normative-vs-informative)
    - [1.2 Core Normative Documents (v3.x)](#12-core-normative-documents-v3x)
    - [1.3 Informative Documents](#13-informative-documents)
  - [2. Repository Layout](#2-repository-layout)
  - [3. Versioning Policy](#3-versioning-policy)
    - [3.1 Semantic Versioning (Specs)](#31-semantic-versioning-specs)
    - [3.2 Alignment Across Documents](#32-alignment-across-documents)
    - [3.3 Python Version Support Declaration](#33-python-version-support-declaration)
  - [4. Rule Catalog & Rule IDs](#4-rule-catalog-rule-ids)
    - [4.1 Rule Catalog Storage](#41-rule-catalog-storage)
    - [4.2 ID Stability](#42-id-stability)
    - [4.3 Deviations Matrix](#43-deviations-matrix)
  - [5. Change Control & Governance](#5-change-control-governance)
    - [5.1 Branching Model](#51-branching-model)
    - [5.2 Change Types](#52-change-types)
    - [5.3 Governance Roles](#53-governance-roles)
  - [6. Publication & Release of the Standard](#6-publication-release-of-the-standard)
    - [6.1 Standard Releases (Spec-Level)](#61-standard-releases-spec-level)
    - [6.2 Backward Compatibility Notes](#62-backward-compatibility-notes)
  - [Backward Compatibility](#backward-compatibility)
    - [6.3 Archive Policy](#63-archive-policy)
  - [7. Machine-Readable Schemas](#7-machine-readable-schemas)
    - [7.1 Required Schemas](#71-required-schemas)
    - [7.2 Schema Versioning](#72-schema-versioning)
