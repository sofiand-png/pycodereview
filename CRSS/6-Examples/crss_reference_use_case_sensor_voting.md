...
- [CRSS-Python Reference Use Case](#crss-python-reference-use-case)
  - [Redundant Sensor Voting + Safe Actuator Limiting](#redundant-sensor-voting-safe-actuator-limiting)
- [🎯 Overview](#🎯-overview)
- [🔧 Functional Scenario](#🔧-functional-scenario)
  - [“Redundant Sensor Voting + Safe Actuator Limit”](#“redundant-sensor-voting-safe-actuator-limit”)
    - [Inputs (per evaluation cycle)](#inputs-per-evaluation-cycle)
    - [Config / constants](#config-constants)
    - [Outputs](#outputs)
- [🚦 Core Safety Logic (High-Level)](#🚦-core-safety-logic-high-level)
    - [1. Sensor plausibility & voting](#1-sensor-plausibility-voting)
    - [2. Safe command envelope](#2-safe-command-envelope)
    - [3. Safe mode triggering](#3-safe-mode-triggering)
    - [4. Determinism & purity](#4-determinism-purity)
- [📁 Suggested File Structure (1–3 Files)](#📁-suggested-file-structure-1-3-files)
  - [1. `safety_types.py`  (Strict)](#1-safetytypespy-strict)
  - [2. `safety_logic.py` (CRSS-Strict)](#2-safetylogicpy-crss-strict)
  - [3. `safety_runner.py` (CRSS-Core)](#3-safetyrunnerpy-crss-core)
