...
- [NOT ALLOWED] Change at runtime
- [NOT ALLOWED] Toggle dynamically
- [NOT ALLOWED] Allow demotion (A -> B -> C)
...
|--------------|----------------------------------|----------------------------|
| Critical     | Safety decisions, bounded timing | [NOT ALLOWED] Alloc, I/O, blocking     |
...
- [NOT ALLOWED] No heap allocation
- [NOT ALLOWED] No I/O
- [NOT ALLOWED] No dynamic imports
- [NOT ALLOWED] No subprocess
- [NOT ALLOWED] No blocking locks
- [NOT ALLOWED] No calling unverified lower-level code
...
- [NOT ALLOWED] MUST NOT be called by critical code
...
| Strict-A (Critical) -> Core | [NOT ALLOWED]       |                                           |
...
- [NOT ALLOWED] Disabled in production
...
- Mode = Core-XXX
- Core rules enforced
- [NOT ALLOWED] No Strict evidence needed
